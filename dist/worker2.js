  ...
  if (e && typeof e == "object" || typeof e == "function") {
    for (let s of Ge(e)) {
      if (!je.call(t, s) && s !== n) {
        J(t, s, {
          get: () => e[s],
          enumerable: !(r = qe(e, s)) || r.enumerable
        });
      }
    }
  }
...
var Je = (t, e, n) => {
  n = t != null ? He(Ve(t)) : {};
  return $e(e || !t || !t.__esModule ? J(n, "default", {
    value: t,
    enumerable: true
  }) : n, t);
};
var Ce = ze((exports, module) => {
        ...
        return initPromise || (Module = Object.assign({}, Module, moduleOptions), initPromise = new Promise(resolveInitPromise => {
          ...
          function locateFile(t) {
            if (Module.locateFile) {
              return Module.locateFile(t, scriptDirectory);
            } else {
              return scriptDirectory + t;
            }
          }
          ...
          if (ENVIRONMENT_IS_NODE) {
            ...
            read_ = (t, e) => {
              ...
              return fs.readFileSync(t, e ? undefined : "utf8");
            };
            readBinary = t => {
              var e = read_(t, true);
              if (!e.buffer) {
            ...
            } else if (document !== undefined && document.currentScript) {
          ...
          function UTF8ArrayToString(t, e, n) {
            for (var r = e + n, s = e; t[s] && s < r;) {
              ++s;
            }
            if (s - e > 16 && t.buffer && UTF8Decoder) {
              return UTF8Decoder.decode(t.subarray(e, s));
            }
            var a = "";
            for (; e < s;) {
              var i = t[e++];
              if (i & 128) {
                ...
                if ((i & 224) != 192) {
                  var _ = t[e++] & 63;
                  if ((i = (i & 240) == 224 ? (i & 15) << 12 | o << 6 | _ : (i & 7) << 18 | o << 12 | _ << 6 | t[e++] & 63) < 65536) {
                  ...
                  a += String.fromCharCode((i & 31) << 6 | o);
                }
              } else {
                a += String.fromCharCode(i);
              }
          ...
          function UTF8ToString(t, e) {
            if (t) {
              return UTF8ArrayToString(HEAPU8, t, e);
            } else {
              return "";
            }
          }
          ...
          function getBinary(t) {
            try {
              if (t == wasmBinaryFile && wasmBinary) {
            ...
            if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
              ...
              if (readAsync) {
                return new Promise(function (t, e) {
                  readAsync(wasmBinaryFile, function (n) {
                    t(new Uint8Array(n));
                  }, e);
                });
              }
          ...
          function createWasm() {
            ...
            function e(s, a) {
              ...
              if (o.neededDynlibs) {
                dynamicLibraries = o.neededDynlibs.concat(dynamicLibraries);
              }
            ...
            if (Module.instantiateWasm) {
              try {
                ...
                err("Module.instantiateWasm callback failed with error: " + s);
                return false;
              }
            }
          ...
          var GOTHandler = {
            get: function (t, e) {
              var n = GOT[e];
              n ||= GOT[e] = new WebAssembly.Global({
                value: "i32",
                mutable: true
              });
              if (!CurrentModuleWeakSymbols.has(e)) {
                n.required = true;
              }
              return n;
            }
          ...
          function getDylinkMetadata(t) {
            ...
            function s() {
              var h = r();
              return UTF8ArrayToString(t, (e += h) - h, h);
            }
            function a(h, c) {
              if (h) {
                throw new Error(c);
            ...
            if (t instanceof WebAssembly.Module) {
              ...
              if (o.length === 0) {
                i = "dylink";
                o = WebAssembly.Module.customSections(t, i);
              }
              a(o.length === 0, "need dylink section");
              n = (t = new Uint8Array(o[0])).length;
            } else {
              a(new Uint32Array(new Uint8Array(t.subarray(0, 24)).buffer)[0] != 1836278016, "need to see wasm magic number");
            ...
            if (i == "dylink") {
              ...
              l.tableSize = r();
              l.tableAlign = r();
              for (var u = r(), d = 0; d < u; ++d) {
                var w = s();
                l.neededDynlibs.push(w);
              }
            } else {
          ...
          function asmjsMangle(t) {
            if (t.indexOf("dynCall_") == 0 || ["stackAlloc", "stackSave", "stackRestore", "getTempRet0", "setTempRet0"].includes(t)) {
              return t;
            } else {
              return "_" + t;
            }
          ...
          function dynCallLegacy(t, e, n) {
            ...
            if (n && n.length) {
              return r.apply(null, [e].concat(n));
            } else {
          ...
          function getWasmTableEntry(t) {
            ...
            if (!e) {
              if (t >= wasmTableMirror.length) {
                wasmTableMirror.length = t + 1;
              }
          ...
          function dynCall(t, e, n) {
            if (t.includes("j")) {
              return dynCallLegacy(t, e, n);
            } else {
              return getWasmTableEntry(e).apply(null, n);
            }
          }
          ...
          function isInternalSym(t) {
            return ["__cpp_exception", "__c_longjmp", "__wasm_apply_data_relocs", "__dso_handle", "__tls_size", "__tls_align", "__set_stack_limits", "_emscripten_tls_init", "__wasm_init_tls", "__wasm_call_ctors", "__start_em_asm", "__stop_em_asm"].includes(t);
          }
          function uleb128Encode(t, e) {
            if (t < 128) {
              e.push(t);
            } else {
              e.push(t % 128 | 128, t >> 7);
            }
          }
          ...
          function convertJsFunctionToWasm(t, e) {
            if (typeof WebAssembly.Function == "function") {
              return new WebAssembly.Function(sigToWasmTypes(e), t);
            }
            var n = [1];
          ...
          function setWasmTableEntry(t, e) {
            wasmTable.set(t, e);
            wasmTableMirror[t] = wasmTable.get(t);
          }
          ...
          function resolveGlobalSymbol(t, e) {
            var n;
            if (e) {
              n = asmLibraryArg["orig$" + t];
            }
            if (!n) {
              if ((n = asmLibraryArg[t]) && n.stub) {
                n = undefined;
              }
            }
            n ||= Module[asmjsMangle(t)];
            if (!n && t.startsWith("invoke_")) {
              n = createInvokeFunction(t.split("_")[1]);
            }
            return n;
          }
          ...
          function loadWebAssemblyModule(binary, flags, handle) {
            ...
            function loadModule() {
              ...
              function resolveSymbol(t) {
                var e = resolveGlobalSymbol(t, false);
                e ||= moduleExports[t];
                return e;
              }
              ...
              var proxyHandler = {
                get: function (t, e) {
                  ...
                  if (e in asmLibraryArg) {
                    return asmLibraryArg[e];
                  }
                  var n;
                  if (!(e in t)) {
                    t[e] = function () {
            ...
            if (flags.loadAsync) {
              return metadata.neededDynlibs.reduce(function (t, e) {
          ...
          function loadDynamicLibrary(t, e, n) {
            ...
            if (r) {
              if (e.global && !r.global) {
                r.global = true;
                if (r.module !== "loading") {
                  mergeLibSymbols(r.module, t);
                }
              }
              if (e.nodelete && r.refcount !== Infinity) {
                r.refcount = Infinity;
              }
              r.refcount++;
              if (n) {
              ...
              return !e.loadAsync || Promise.resolve(true);
            }
            function s(o) {
              if (e.fs && e.fs.findObject(o)) {
                var _ = e.fs.readFile(o, {
                  encoding: "binary"
                });
              ...
              if (e.loadAsync) {
                return new Promise(function (l, u) {
                  readAsync(o, d => l(new Uint8Array(d)), u);
                });
              }
              if (!readBinary) {
            ...
            function a() {
              if (typeof preloadedWasm !== "undefined" && preloadedWasm[t]) {
              ...
              if (e.loadAsync) {
                return s(t).then(function (_) {
                  return loadWebAssemblyModule(_, e, n);
                });
              } else {
                return loadWebAssemblyModule(s(t), e, n);
              }
            }
            function i(o) {
              if (r.global) {
          ...
          function reportUndefinedSymbols() {
            for (var t in GOT) {
              if (GOT[t].value == 0) {
                var e = resolveGlobalSymbol(t, true);
                if (!e && !GOT[t].required) {
                  continue;
                }
                if (typeof e == "function") {
                  GOT[t].value = addFunction(e, e.sig);
                } else {
                  if (typeof e != "number") {
                    throw new Error("bad export type for `" + t + "`: " + typeof e);
                  }
                  GOT[t].value = e;
                }
              }
          ...
          function preloadDylibs() {
            if (dynamicLibraries.length) {
              ...
              dynamicLibraries.reduce(function (t, e) {
                return t.then(function () {
          ...
          function setValue(t, e, n = "i8") {
            ...
            switch (n) {
              ...
              case "i32":
                ...
                break;
              case "i64":
                tempI64 = [e >>> 0, (tempDouble = e, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)];
          ...
          function _emscripten_resize_heap(t) {
            ...
            for (var r = 1; r <= 4; r *= 2) {
              ...
              if (emscripten_realloc_buffer(Math.min(n, (a = Math.max(t, s)) + ((i = 65536) - a % i) % i))) {
                return true;
              }
            }
            var a;
          ...
          var SYSCALLS = {
            ...
            calculateAt: function (t, e, n) {
              ...
              if (t === -100) {
                ...
                r = SYSCALLS.getStreamFromFD(t).path;
              }
              if (e.length == 0) {
                if (!n) {
            ...
            doStat: function (t, e, n) {
              try {
                ...
                if (o && o.node && PATH.normalize(e) !== PATH.normalize(FS.getPath(o.node))) {
                  return -54;
                }
                throw o;
              }
              ...
              tempI64 = [r.size >>> 0, (tempDouble = r.size, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)];
              HEAP32[n + 40 >> 2] = tempI64[0];
              HEAP32[n + 44 >> 2] = tempI64[1];
              HEAP32[n + 48 >> 2] = 4096;
              HEAP32[n + 52 >> 2] = r.blocks;
              var s = r.atime.getTime();
              var a = r.mtime.getTime();
              var i = r.ctime.getTime();
              tempI64 = [Math.floor(s / 1000) >>> 0, (tempDouble = Math.floor(s / 1000), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)];
              HEAP32[n + 56 >> 2] = tempI64[0];
              HEAP32[n + 60 >> 2] = tempI64[1];
              HEAPU32[n + 64 >> 2] = s % 1000 * 1000;
              tempI64 = [Math.floor(a / 1000) >>> 0, (tempDouble = Math.floor(a / 1000), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)];
              HEAP32[n + 72 >> 2] = tempI64[0];
              HEAP32[n + 76 >> 2] = tempI64[1];
              HEAPU32[n + 80 >> 2] = a % 1000 * 1000;
              tempI64 = [Math.floor(i / 1000) >>> 0, (tempDouble = Math.floor(i / 1000), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)];
              HEAP32[n + 88 >> 2] = tempI64[0];
              HEAP32[n + 92 >> 2] = tempI64[1];
              HEAPU32[n + 96 >> 2] = i % 1000 * 1000;
              tempI64 = [r.ino >>> 0, (tempDouble = r.ino, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)];
          ...
          function _fd_close(t) {
            try {
              ...
              if (typeof FS === "undefined" || !(n instanceof FS.ErrnoError)) {
                throw n;
              }
              return n.errno;
            }
          ...
          function convertI32PairToI53Checked(t, e) {
            if (e + 2097152 >>> 0 < 4194305 - !!t) {
              return (t >>> 0) + e * 4294967296;
            } else {
              return NaN;
            }
          }
          function _fd_seek(t, e, n, r, s) {
            try {
              ...
              FS.llseek(i, a, r);
              tempI64 = [i.position >>> 0, (tempDouble = i.position, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)];
              HEAP32[s >> 2] = tempI64[0];
              HEAP32[s + 4 >> 2] = tempI64[1];
              if (i.getdents && a === 0 && r === 0) {
                i.getdents = null;
              }
              return 0;
            } catch (o) {
              if (typeof FS === "undefined" || !(o instanceof FS.ErrnoError)) {
                throw o;
              }
              return o.errno;
            }
          ...
          function _fd_write(t, e, n, r) {
            try {
              ...
              if (typeof FS === "undefined" || !(a instanceof FS.ErrnoError)) {
                throw a;
              }
              return a.errno;
            }
          ...
          function _tree_sitter_parse_callback(t, e, n, r, s) {
            var a = currentParseCallback(e, {
              row: n,
              column: r
            });
            if (typeof a == "string") {
              setValue(s, a.length, "i32");
              stringToUTF16(a, t, 10240);
            } else {
              setValue(s, 0, "i32");
            }
          }
          function handleException(t) {
            if (t instanceof ExitStatus || t == "unwind") {
              return EXITSTATUS;
            }
            quit_(1, t);
          }
          function allocateUTF8OnStack(t) {
            ...
            var n = stackAlloc(e);
            stringToUTF8Array(t, HEAP8, n, e);
            return n;
          }
          function stringToUTF16(t, e, n = 2147483647) {
            if (n < 2) {
              return 0;
            }
            var r = e;
            for (var s = (n -= 2) < t.length * 2 ? n / 2 : t.length, a = 0; a < s; ++a) {
          ...
          function run(t) {
            ...
            t = t || arguments_;
            if (runDependencies <= 0 && (!!dylibsLoaded || !(preloadDylibs(), dylibsLoaded = true, runDependencies > 0))) {
              preRun();
          ...
          let INTERNAL = {};
          let SIZE_OF_INT = 4;
          let SIZE_OF_NODE = SIZE_OF_INT * 5;
          let SIZE_OF_POINT = SIZE_OF_INT * 2;
          let SIZE_OF_RANGE = SIZE_OF_INT * 2 + SIZE_OF_POINT * 2;
          let ZERO_POINT = {
            row: 0,
            column: 0
          };
          let QUERY_WORD_REGEX = /[\w-.]*/g;
          let PREDICATE_STEP_TYPE_CAPTURE = 1;
          let PREDICATE_STEP_TYPE_STRING = 2;
          let LANGUAGE_FUNCTION_REGEX = /^_?tree_sitter_\w+/;
          var VERSION;
          ...
          class ParserImpl {
            ...
            setLanguage(e) {
              ...
              this.language = e;
              C._ts_parser_set_language(this[0], n);
              return this;
            }
            getLanguage() {
            ...
            parse(e, n, r) {
              if (typeof e == "string") {
                currentParseCallback = (_, l, u) => e.slice(_, u);
              } else {
                if (typeof e != "function") {
              ...
              if (r && r.includedRanges) {
                s = r.includedRanges.length;
                a = C._calloc(s, SIZE_OF_RANGE);
                let _ = a;
                for (let l = 0; l < s; l++) {
                  marshalRange(_, r.includedRanges[l]);
                  _ += SIZE_OF_RANGE;
                }
              }
          ...
          class Tree {
            ...
            getChangedRanges(e) {
              ...
              let r = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32");
              let s = new Array(n);
              if (n > 0) {
                let a = r;
                for (let i = 0; i < n; i++) {
                  s[i] = unmarshalRange(a);
                  a += SIZE_OF_RANGE;
                }
                C._free(r);
              }
          ...
          class Node {
            ...
            get children() {
              if (!this._children) {
                ...
                let n = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32");
                this._children = new Array(e);
                if (e > 0) {
                  let r = n;
                  for (let s = 0; s < e; s++) {
                    this._children[s] = unmarshalNode(this.tree, r);
                    r += SIZE_OF_NODE;
                  }
                  C._free(n);
                }
            ...
            get namedChildren() {
              if (!this._namedChildren) {
                ...
                if (e > 0) {
                  let r = n;
                  for (let s = 0; s < e; s++) {
                    this._namedChildren[s] = unmarshalNode(this.tree, r);
                    r += SIZE_OF_NODE;
                  }
                  C._free(n);
                }
            ...
            descendantsOfType(e, n, r) {
              ...
              r ||= ZERO_POINT;
              let s = [];
              let a = this.tree.language.types;
              ...
              for (let u = 0, d = s.length; u < d; u++) {
                setValue(i + u * SIZE_OF_INT, s[u], "i32");
              }
              marshalNode(this);
              ...
              let _ = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32");
              let l = new Array(o);
              if (o > 0) {
                let u = _;
                for (let d = 0; d < o; d++) {
                  l[d] = unmarshalNode(this.tree, u);
                  u += SIZE_OF_NODE;
                }
              }
              C._free(_);
          ...
          class TreeCursor {
            ...
            get nodeText() {
              ...
              let n = C._ts_tree_cursor_end_index_wasm(this.tree[0]);
          ...
          class Language {
            constructor(e, n) {
              ...
              for (let r = 0, s = this.types.length; r < s; r++) {
                if (C._ts_language_symbol_type(this[0], r) < 2) {
            ...
            query(e) {
              ...
              if (!s) {
                ...
                let g = UTF8ToString(r, getValue(TRANSFER_BUFFER, "i32")).length;
                let h = e.substr(g, 100).split(`
`)[0];
                let c;
                let b = h.match(QUERY_WORD_REGEX)[0];
                switch (m) {
                  case 2:
                    c = new RangeError(`Bad node name '${b}'`);
                    break;
                  case 3:
                    c = new RangeError(`Bad field name '${b}'`);
                    break;
                  case 4:
                    c = new RangeError(`Bad capture name @${b}`);
                    break;
                  case 5:
                    c = new TypeError(`Bad pattern structure at offset ${g}: '${h}'...`);
                    b = "";
                    break;
                  default:
                    c = new SyntaxError(`Bad syntax at offset ${g}: '${h}'...`);
                    b = "";
                }
                c.index = g;
                c.length = b.length;
              ...
              let i = C._ts_query_capture_count(s);
              let o = C._ts_query_pattern_count(s);
              let _ = new Array(i);
              let l = new Array(a);
              for (let m = 0; m < i; m++) {
                let g = C._ts_query_capture_name_for_id(s, m, TRANSFER_BUFFER);
                let h = getValue(TRANSFER_BUFFER, "i32");
                _[m] = UTF8ToString(g, h);
              }
              for (let m = 0; m < a; m++) {
                let g = C._ts_query_string_value_for_id(s, m, TRANSFER_BUFFER);
                let h = getValue(TRANSFER_BUFFER, "i32");
                l[m] = UTF8ToString(g, h);
              }
              let u = new Array(o);
              let d = new Array(o);
              let w = new Array(o);
              ...
              let M = new Array(o);
              for (let m = 0; m < o; m++) {
                let g = C._ts_query_predicates_for_pattern(s, m, TRANSFER_BUFFER);
                let h = getValue(TRANSFER_BUFFER, "i32");
                f[m] = [];
                M[m] = [];
                let c = [];
                ...
                for (let de = 0; de < h; de++) {
                  let me = getValue(b, "i32");
                  b += SIZE_OF_INT;
                  let pe = getValue(b, "i32");
                  b += SIZE_OF_INT;
                  if (me === PREDICATE_STEP_TYPE_CAPTURE) {
                    c.push({
                      type: "capture",
                      name: _[pe]
                    });
                  } else if (me === PREDICATE_STEP_TYPE_STRING) {
                    c.push({
                      type: "string",
                      value: l[pe]
                    });
                    ...
                    switch (O) {
                      ...
                      case "eq?":
                        ...
                        if (c[2].type === "capture") {
                          ...
                          M[m].push(function (Q) {
                            ...
                            return F === undefined || $ === undefined || F.text === $.text === L;
                          });
                        } else {
                          let R = c[1].name;
                          let A = c[2].value;
                      ...
                      case "match?":
                        ...
                        let We = c[1].name;
                        let Ze = new RegExp(c[2].value);
                        M[m].push(function (R) {
                          for (let A of R) {
                            if (A.name === We) {
                              return Ze.test(A.node.text) === L;
                            }
                          }
                          return true;
                        });
                      ...
                      case "set!":
                        ...
                        if (c.some(R => R.type !== "string")) {
                          throw new Error("Arguments to `#set!` predicate must be a strings.\".");
                        }
                        u[m] ||= {};
                        u[m][c[1].value] = c[2] ? c[2].value : null;
                        break;
                      case "is?":
                      case "is-not?":
                        if (c.length < 2 || c.length > 3) {
                          throw new Error(`Wrong number of arguments to \`#${O}\` predicate. Expected 1 or 2. Got ${c.length - 1}.`);
                        }
                        if (c.some(R => R.type !== "string")) {
                        ...
                        let z = O === "is?" ? d : w;
                        z[m] ||= {};
                        z[m][c[1].value] = c[2] ? c[2].value : null;
                        break;
                      default:
                        f[m].push({
                          operator: O,
              ...
              C._free(r);
              return new Query(INTERNAL, s, _, M, f, Object.freeze(u), Object.freeze(d), Object.freeze(w));
            }
            static load(e) {
              let n;
              if (e instanceof Uint8Array) {
                ...
                if (typeof process !== "undefined" && process.versions && process.versions.node) {
                  ...
                  n = fetch(s).then(a => a.arrayBuffer().then(i => {
                    if (a.ok) {
...
${o}`);
              ...
              return n.then(s => r(s, {
                ...
                let a = Object.keys(s);
                let i = a.find(_ => LANGUAGE_FUNCTION_REGEX.test(_) && !_.includes("external_scanner_"));
                if (!i) {
...
${JSON.stringify(a, null, 2)}`);
          ...
          class Query {
            ...
            matches(e, n, r, s) {
              ...
              marshalNode(e);
              C._ts_query_matches_wasm(this[0], e.tree[0], n.row, n.column, r.row, r.column, a);
              let i = getValue(TRANSFER_BUFFER, "i32");
              let o = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32");
              let _ = getValue(TRANSFER_BUFFER + SIZE_OF_INT * 2, "i32");
              let l = new Array(i);
              this.exceededMatchLimit = !!_;
              let u = 0;
              let d = o;
              for (let w = 0; w < i; w++) {
                let f = getValue(d, "i32");
                d += SIZE_OF_INT;
                let M = getValue(d, "i32");
                d += SIZE_OF_INT;
                let m = new Array(M);
                d = unmarshalCaptures(this, e.tree, d, m);
                if (this.textPredicates[f].every(g => g(m))) {
                  l[u++] = {
                    pattern: f,
                    captures: m
                  };
                  ...
                  let h = this.assertedProperties[f];
                  if (h) {
                    l[w].assertedProperties = h;
                  }
                  let c = this.refutedProperties[f];
                  if (c) {
                    l[w].refutedProperties = c;
                  }
                }
              }
              l.length = u;
            ...
            captures(e, n, r, s) {
              ...
              marshalNode(e);
              C._ts_query_captures_wasm(this[0], e.tree[0], n.row, n.column, r.row, r.column, a);
              let i = getValue(TRANSFER_BUFFER, "i32");
              let o = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32");
              let _ = getValue(TRANSFER_BUFFER + SIZE_OF_INT * 2, "i32");
              let l = [];
              ...
              for (let w = 0; w < i; w++) {
                ...
                d += SIZE_OF_INT;
                u.length = M;
                d = unmarshalCaptures(this, e.tree, d, u);
                if (this.textPredicates[f].every(g => g(u))) {
                  let g = u[m];
                  let h = this.setProperties[f];
                  if (h) {
                    g.setProperties = h;
                  }
                  let c = this.assertedProperties[f];
                  if (c) {
                    g.assertedProperties = c;
                  }
                  let b = this.refutedProperties[f];
                  if (b) {
                    g.refutedProperties = b;
                  }
                  l.push(g);
                }
              }
          ...
          function unmarshalCaptures(t, e, n, r) {
            for (let s = 0, a = r.length; s < a; s++) {
              ...
              let o = unmarshalNode(e, n += SIZE_OF_INT);
              n += SIZE_OF_NODE;
              r[s] = {
                name: t.captureNames[i],
                node: o
              };
            }
            return n;
          ...
          function unmarshalNode(t, e = TRANSFER_BUFFER) {
            ...
            let s = getValue(e += SIZE_OF_INT, "i32");
            let a = getValue(e += SIZE_OF_INT, "i32");
            let i = getValue(e += SIZE_OF_INT, "i32");
            let o = new Node(INTERNAL, t);
            o.id = n;
            o.startIndex = r;
            o.startPosition = {
              row: s,
          ...
          function marshalTreeCursor(t, e = TRANSFER_BUFFER) {
            setValue(e + SIZE_OF_INT * 0, t[0], "i32");
            setValue(e + SIZE_OF_INT * 1, t[1], "i32");
            setValue(e + SIZE_OF_INT * 2, t[2], "i32");
          }
          function unmarshalTreeCursor(t) {
            t[0] = getValue(TRANSFER_BUFFER + SIZE_OF_INT * 0, "i32");
            t[1] = getValue(TRANSFER_BUFFER + SIZE_OF_INT * 1, "i32");
            t[2] = getValue(TRANSFER_BUFFER + SIZE_OF_INT * 2, "i32");
          }
          function marshalPoint(t, e) {
            setValue(t, e.row, "i32");
            setValue(t + SIZE_OF_INT, e.column, "i32");
          }
          function unmarshalPoint(t) {
            return {
              row: getValue(t, "i32"),
              column: getValue(t + SIZE_OF_INT, "i32")
            };
          }
...
var Be = require("worker_threads");
var ce = {};
Qe(ce, {
  _clean: () => et,
  _extractDoc: () => It,
  _getCallExpressions: () => _t,
  _getClassDeclarations: () => ut,
  _getClassReferences: () => mt,
  _getCoarseParentScope: () => yt,
  _getDocumentableNodeIfOnIdentifier: () => bt,
  _getFineScopes: () => St,
  _getFixSelectionOfInterest: () => wt,
  _getFunctionBodies: () => ht,
  _getFunctionDefinitions: () => lt,
  _getFunctionPositions: () => gt,
  _getNodeMatchingSelection: () => j,
  _getNodeToDocument: () => xt,
  _getNodeToExplain: () => Mt,
  _getSemanticChunkTree: () => ft,
  _getStructure: () => Pt,
  _getSymbols: () => pt,
  _getTestableNode: () => Et,
  _getTypeDeclarations: () => ct,
  _getTypeReferences: () => dt,
  _parse: () => y
});
var U = Je(require("path"));
function fe(t, e, n) {
  let r = 0;
  let s = t.length;
  while (r < s) {
...
var Y = class {
  constructor() {
    ...
    this.unexpectedErrorHandler = function (e) {
      setTimeout(() => {
        throw e.stack ? H.isErrorNoTelemetry(e) ? new H(`${e.message}
...
var E = {
  ...
  isEqual: (t, e) => E.compare(t, e) === 0,
  doIntersect: (t, e) => {
    let n = Math.max(t.startIndex, e.startIndex);
    let r = Math.min(t.endIndex, e.endIndex);
    return n < r;
  },
...
var T = {
  ...
  isAfter(t, e) {
    return T.isBefore(e, t);
  },
  isBeforeOrEqual(t, e) {
    let n = T.isBefore(t, e);
    let r = T.isEqual(t, e);
    return !!n || !!r;
  },
  equals(t, e) {
...
var v = {
  doesContain: (t, e) => T.isBeforeOrEqual(t.startPosition, e.startPosition) && T.isAfterOrEqual(t.endPosition, e.endPosition),
  equals: (t, e) => T.equals(t.startPosition, e.startPosition) && T.equals(t.endPosition, e.endPosition),
  ofSyntaxNode: t => ({
...
var k = class {
  constructor(e, n, r, s) {
    ...
    this.children = s;
    if (e > n) {
      throw new q("startIndex must be less than endIndex");
    }
  }
  toString() {
    let e = [];
    function n(r, s = "") {
      e.push(`${s}${r.kind} [${r.startIndex}, ${r.endIndex}]`);
      r.children.forEach(a => n(a, s + "    "));
    }
    n(this);
    return e.join(`
`);
...
var V = class {
  ...
  formTree(e) {
    ...
    let n = [];
    let r = () => n[n.length - 1];
    let s = (a, i) => a.mainBlock.startIndex === i.mainBlock.startIndex && a.mainBlock.endIndex === i.mainBlock.endIndex;
    for (let a of e) {
      let i = {
        info: a,
        children: []
      ...
      if (!s(o.info, a)) {
        while (o && !E.doesContain(o.info.mainBlock, a.mainBlock)) {
          n.pop();
          o = r();
        }
        if (o) {
...
var ye = {
  ...S(["javascript", "typescript", "tsx"], ["(class_declaration) @class_declaration"]),
...
var Ee = {
  ...S(["javascript", "typescript", "tsx"], [`(new_expression
...
var Se = {
  python: [`[
			...
			(assignment
				...
				right: (lambda) @body)
		] @function`, "(ERROR (\"def\" (identifier) (parameters))) @function"],
  ...S(["javascript", "typescript", "tsx"], [`[
			(function
				name: (identifier)? @identifier
...
var xe = {
  javascript: [p.javascript`((comment) @comment
			(#match? @comment "^\\\\/\\\\*\\\\*")) @docComment`],
  ...S(["typescript", "tsx"], [p.typescript`((comment) @comment
			(#match? @comment "^\\\\/\\\\*\\\\*")) @docComment`]),
  java: [p.java`((block_comment) @block_comment
			(#match? @block_comment "^\\\\/\\\\*\\\\*")) @docComment`],
  cpp: [p.cpp`((comment) @comment
			(#match? @comment "^\\\\/\\\\*\\\\*")) @docComment`],
  csharp: [p.csharp`(
			((comment) @c
				(#match? @c "^\\\\/\\\\/\\\\/"))+
		) @docComment`],
  rust: [p.rust`((line_comment) @comment
			(#match? @comment "^\/\/\/|^\/\/!"))+ @docComment`],
  go: [p.go`((comment)+) @docComment`],
  ruby: [p.ruby`((comment)+) @docComment`],
...
var Ne = {
  ...S(["typescript", "tsx"], ["program", "interface_declaration", "class_declaration", "function_declaration", "function", "type_alias_declaration", "method_definition"]),
...
var Re = {
  ...S(["typescript", "tsx", "javascript"], ["for_in_statement", "for_statement", "if_statement", "while_statement", "do_statement", "try_statement", "switch_statement"]),
  java: ["for_statement", "enhanced_for_statement", "if_statement", "while_statement", "do_statement", "try_statement", "switch_expression"],
  cpp: ["for_statement", "for_range_loop", "if_statement", "while_statement", "do_statement", "try_statement", "switch_statement"],
  csharp: ["for_statement", "for_each_statement", "if_statement", "while_statement", "do_statement", "try_statement", "switch_expression"],
...
var Ye = {
  ...S(["typescript", "tsx"], ["lexical_declaration", "expression_statement", "public_field_definition"]),
  ...
  rust: ["expression_statement", "let_declaration", "use_declaration", "assignment_expression", "macro_definition", "extern_crate_declaration"]
};
var Xe = {
  ...S(["typescript", "tsx"], ["class_declaration", "function_declaration", "generator_function_declaration", "interface_declaration", "internal_module", "method_definition"]),
  javascript: ["class_declaration", "function_declaration", "generator_function_declaration", "method_definition"],
  java: ["class_declaration", "constructor_declaration", "enum_declaration", "interface_declaration", "method_declaration", "module_declaration"],
  cpp: ["class_specifier", "function_definition", "namespace_definition", "struct_specifier"],
  csharp: ["class_declaration", "constructor_declaration", "destructor_declaration", "enum_declaration", "interface_declaration", "method_declaration", "namespace_declaration", "struct_declaration"],
...
function N(t) {
  return Ne[t].map(e => `(${e}) @scope`).join(`
`);
}
function P(t) {
  return `[
...
function D(t, e) {
  return Ne[t].includes(e.type) || Re[t].includes(e.type);
}
function Ae(t, e) {
  return Re[t].includes(e.type);
}
function X(t, e) {
  return Ye[t].includes(e.type);
}
var ee = Ce();
var te = class {
  constructor() {
  ...
  loadLanguage(e) {
    if (!this.loadedLanguagesCache.has(e)) {
      this.loadedLanguagesCache.set(e, this._doLoadLanguage(e));
    }
    return this.loadedLanguagesCache.get(e);
  }
  _doLoadLanguage(e) {
    let r = `tree-sitter-${e === "csharp" ? "c-sharp" : e}.wasm`;
    let s = U.basename(__dirname) === "dist" ? U.resolve(__dirname, r) : U.resolve(__dirname, "../../../../dist", r);
    return ee.Language.load(s);
  }
};
var ne = class t {
  static {
  ...
  delete() {
    ...
    for (let e of this.caches.values()) {
      e.dispose();
    }
  }
  getParseTreeCache(e) {
    ...
    if (!n) {
      n = new Z(t.CACHE_SIZE_PER_LANGUAGE);
      this.caches.set(e, n);
    }
    return n;
  }
...
var ie = class {
  ...
  getQuery(e) {
    if (!this.map.has(e)) {
      this.map.set(e, this.language.query(e));
    }
...
var oe = class t {
  ...
  getQuery(e, n) {
    if (!this.map.has(e)) {
      this.map.set(e, new ie(e));
    }
    return this.map.get(e).getQuery(n);
  }
};
function x(t, e) {
  let n = [];
  for (let r of t) {
    let s = oe.INSTANCE.getQuery(e.tree.getLanguage(), r);
    n.push(...s.matches(e));
  }
  return n;
}
...
async function _t(t, e, n) {
  let r = await y(t, e);
  try {
    return nt(t, r.tree.rootNode).reduce((i, o) => {
      let _ = o.captures.find(l => l.name === "call_expression").node;
      if (E.doIntersect(n, _)) {
        let l;
        let u;
        if (t === "ruby") {
          u = o.captures.find(d => d.name === "symbol")?.node;
          l = u?.text?.slice(1);
        }
        u ??= o.captures.find(d => d.name === "identifier")?.node;
        l ??= u?.text;
        i.push({
          identifier: l ?? "",
          text: _.text,
          startIndex: (u ?? _).startIndex,
          endIndex: (u ?? _).endIndex
        });
      }
      return i;
    }, []);
...
async function lt(t, e) {
  let n = await y(t, e);
  try {
    return le(t, n.tree.rootNode).map(a => {
...
async function ut(t, e) {
  let n = await y(t, e);
  try {
    return rt(t, n.tree.rootNode).map(a => {
      let i = a.captures.find(_ => _.name === "class_declaration").node;
      return {
        identifier: i?.children.find(_ => _.type === "type_identifier" || _.type === "identifier" || _.type === "constant")?.text ?? "",
        text: i.text,
        startIndex: i.startIndex,
        endIndex: i.endIndex
      };
...
async function ct(t, e) {
  let n = await y(t, e);
  try {
    return st(t, n.tree.rootNode).map(a => {
      let i = a.captures.find(_ => _.name === "type_declaration").node;
      let o = a.captures.find(_ => _.name === "type_identifier")?.node.text;
      o ||= i?.children.find(_ => _.type === "type_identifier")?.text;
      return {
        identifier: o ?? "",
        text: i.text,
        startIndex: i.startIndex,
...
async function dt(t, e, n) {
  let r = await y(t, e);
  try {
    return at(t, r.tree.rootNode).reduce((i, o) => {
...
async function mt(t, e, n) {
  let r = await y(t, e);
  try {
    return it(t, r.tree.rootNode).reduce((i, o) => {
...
async function pt(t, e, n) {
  ...
  try {
    let s = Te[t];
    return x(s, r.tree.rootNode).reduce((o, _) => {
      let l = _.captures.find(u => u.name === "symbol").node;
      if (E.doIntersect(n, l)) {
        o.push({
          identifier: l.text,
          text: l.text,
...
async function ft(t, e) {
  let n = await y(t, e);
  try {
    let r = ot(t, n.tree.rootNode);
    return Rt(t, r, n.tree.rootNode);
  } finally {
    n.dispose();
  }
}
...
async function yt(t, e, n) {
  let r = await y(t, e);
  try {
    let s = tt(t, r.tree.rootNode);
    let a;
    for (let i of s) {
      let o = i.captures[0].node;
      let _ = v.ofSyntaxNode(o);
      if (v.doesContain(_, n)) {
        a = o;
      }
      if (T.isBefore(n.endPosition, _.startPosition)) {
        break;
      }
    }
    if (a) {
      return v.ofSyntaxNode(a);
    }
...
async function wt(t, e, n, r) {
  let s = await y(t, e);
  try {
    let a = s.tree.rootNode.descendantForPosition(n.startPosition, n.endPosition);
    let i = {
      startPosition: a.startPosition,
      endPosition: a.endPosition
    };
    let o = De(t, a, r, n, true);
    if (v.equals(i, o)) {
      return ke(t, a);
    } else {
      return o;
...
function Ue(t, e, n, r) {
  ...
  let a;
  if (r) {
    s = e.filter(i => D(t, i) || X(t, i));
    a = fe(s, n, (i, o) => T.isBefore(i.startPosition, o.startPosition));
    s.splice(a, 0, n);
  } else {
    s = e.filter(i => v.doesContain(i, n) || D(t, i) || X(t, i));
    a = s.findIndex(i => v.doesContain(i, n));
  }
  if (a === -1) {
...
function j(t, e, n, r = ue) {
  let s = [t.rootNode];
  let a = [];
  while (true) {
    let i = s.map(o => [o, E.intersectionSize(o, e)]).filter(([o, _]) => _ > 0).sort(([o, _], [l, u]) => u - _);
    if (i.length === 0) {
      if (a.length === 0) {
        return undefined;
      } else {
        return ge(a, ([o, _], [l, u]) => _ - u)[0];
      }
    }
    {
      let o = i.map(([_, l]) => {
        let u = E.len(_);
        let d = Math.abs(E.len(e) - l);
        let f = (l - d) / u;
        return [_, f];
      });
      a.push(...o.filter(([_, l]) => r(_, n)));
      s = [];
      s.push(...o.flatMap(([_, l]) => _.children));
    }
  }
}
async function bt(t, e, n) {
  let r = await y(t, e);
  try {
    let s = r.tree.rootNode.descendantForIndex(n.startIndex, n.endIndex);
    if (s.type.match(/identifier/) && (s.parent === null || ue(s.parent, t))) {
      let a = s.parent;
      let i = a === null ? undefined : {
...
async function Et(t, e, n) {
  ...
  try {
    let s = Me[t];
    let o = x(s, r.tree.rootNode).flatMap(({
      captures: _
    }) => _).filter(({
      name: _
    }) => _.endsWith("identifier")).find(({
      node: _
    }) => E.doesContain(_, n));
    if (o) {
      return {
        identifier: o.node.text
      };
    } else {
      return undefined;
    }
...
async function St(t, e, n) {
  let r = [];
  let i = (await y(t, e)).tree.rootNode.descendantForIndex(n.startIndex, n.endIndex);
  while (i !== null) {
    if (Ae(t, i)) {
      r.push({
        startIndex: i.startIndex,
...
async function xt(t, e, n) {
  let r = await y(t, e);
  try {
    let a = n.startIndex === n.endIndex ? undefined : j(r.tree, n, t);
    if (a) {
      return {
        nodeIdentifier: _e(a, t),
        nodeToDocument: G.ofSyntaxNode(a),
        nodeSelectionBy: "matchingSelection"
      };
    }
    let o = r.tree.rootNode.descendantForIndex(n.startIndex, n.endIndex);
    let _ = 0;
    while (!ue(o, t) && o.parent !== null) {
      o = o.parent;
      ++_;
    }
    return {
      nodeIdentifier: _e(o, t),
      nodeToDocument: G.ofSyntaxNode(o),
...
async function Mt(t, e, n) {
  let r = await y(t, e);
  try {
    let s = n.startIndex === n.endIndex;
    if (s) {
      return;
    }
    let a = s ? undefined : j(r.tree, n, t);
    let i = s ? undefined : j(r.tree, n, t, Tt);
    if (i && a) {
      return {
        nodeIdentifier: _e(a, t),
        nodeToExplain: G.ofSyntaxNode(i)
      };
    }
  } finally {
    r.dispose();
...
function _e(t, e) {
  switch (e) {
    ...
    case "go":
      {
        ...
        if (n) {
          ...
          return t.children.find(s => s.type.match(/spec/))?.children.find(s => s.type.match(/identifier/))?.text;
        }
      }
    case "javascript":
    ...
    case "cpp":
      {
        let n = t.children.find(s => s.type.match(/declarator/));
        if (n) {
          return n.children.find(s => s.type.match(/identifier/))?.text;
        } else {
          return t.children.find(s => s.type.match(/identifier/))?.text;
        }
      }
    case "java":
      {
        ...
        if (n) {
          ...
          return t.children.find(s => s.type.match(/declarator/))?.children.find(s => s.type.match(/identifier/))?.text;
        }
      }
    case "ruby":
...
function Tt(t, e) {
  return t.type.match(/definition/);
}
function ue(t, e) {
  switch (e) {
    case "typescript":
    ...
    case "cpp":
      return t.type.match(/definition|declaration|class_specifier/);
    case "ruby":
...
async function It(t, e) {
  if (!new Set(["javascript", "typescript", "java", "cpp", "csharp", "go", "ruby"]).has(t)) {
    return;
  }
  let r = await y(t, e);
  try {
    let s = xe[t];
    let a = x(s, r.tree.rootNode).flatMap(o => o.captures.filter(_ => _.name === "docComment"));
    let i = Nt(a);
    if (i.length > 1) {
      i = i.filter(o => o.includes(`
`) || !o.match(/(implementation code|code implementation|implementation details|\.\.\.)/i));
    }
    if (i.length === 1) {
      return i[0];
    }
...
function Nt(t) {
  ...
  for (let n = 0; n < t.length; ++n) {
    let r = [t[n].node.text];
    while (n + 1 < t.length && t[n].node.endPosition.row + 1 === t[n + 1].node.startPosition.row) {
      ++n;
      r.push(t[n].node.text);
    }
    e.push(r.join(`
`));
  }
...
async function Pt(t, e) {
  ...
  let r = await y(t, e);
  try {
    let s = x(n, r.tree.rootNode).flatMap(_ => _.captures).sort((_, l) => E.compare(_.node, l.node));
    let a = [];
    for (let _ of s) {
      if (_.name.endsWith(".exclude_captures")) {
        a.push(E.ofSyntaxNode(_.node));
      }
    }
    let i = new k(0, e.length, "root", []);
    let o = [i];
    for (let _ = 0; _ < s.length; ++_) {
      let u = s[_].node;
      if (a.some(f => E.isEqual(f, u))) {
        continue;
      }
      let d;
      do {
        d = o.pop();
      } while (d && !E.doesContain(d, u));
      if (new Set(["export_statement", "ambient_declaration"]).has(d.kind)) {
        d.kind = u.type;
        o.push(d);
      } else {
        let f = new k(u.startIndex, u.endIndex, u.type, []);
        d.children.push(f);
        o.push(d, f);
      }
    }
    ...
    console.error(s instanceof Error ? s : new Error(s));
  } finally {
    r.dispose();
  }
}
function Rt(t, e, n) {
  ...
  return new V(r, I.ofSyntaxNode(n));
}
function vt(t, e) {
  let n = new Map();
  t.forEach(r => {
    let a = r.captures.find(o => o.name === "definition")?.node;
    let i = a?.childForFieldName("body");
    if (a && i) {
      let o;
      switch (e) {
        case "typescript":
      ...
      if (!n.get(a.id)) {
        n.set(a.id, {
          mainBlock: I.ofSyntaxNode(a),
          detailBlocks: {
            comments: o.map(l => I.ofSyntaxNode(l)),
            body: I.ofSyntaxNode(i)
          }
        });
      }
    }
...
function Ct(t) {
  ...
  t.forEach(n => {
    ...
    if (s) {
      ...
      if (i) {
        let o = a[a.length - 1];
        let _ = s.text.substring(i.startIndex - s.startIndex, o.endIndex - s.startIndex);
        let l = B(s);
        if (!e.get(s.id)) {
          e.set(s.id, {
            mainBlock: I.ofSyntaxNode(s),
            detailBlocks: {
              comments: l.map(d => I.ofSyntaxNode(d)),
              body: {
                range: {
                  startPosition: {
                    row: i.startPosition.row,
                    column: i.startPosition.column
                  },
                  endPosition: {
                    row: o.endPosition.row,
                    column: o.endPosition.column
                  }
                },
                startIndex: i.startIndex,
                text: _,
...
function Ft(t) {
  ...
  t.forEach(n => {
    ...
    let a = s?.childForFieldName("body");
    if (s && a) {
      let i = Dt(a);
      let o = kt(s);
      e.set(s.id, {
        mainBlock: I.ofSyntaxNode(s),
        detailBlocks: {
          docstring: i ? I.ofSyntaxNode(i) : undefined,
          decorator: o ? I.ofSyntaxNode(o) : undefined,
          body: I.ofSyntaxNode(a)
        }
      });
      return;
    }
...
function B(t, e = ["comment"]) {
  let n = [];
  let r = t.previousNamedSibling;
  while (r && e.some(s => s === r?.type)) {
    n.push(r);
    r = r.previousNamedSibling;
  }
  return n.reverse();
}
function Ot(t) {
  let e = t.parent;
  if (e?.type === "export_statement") {
    return {
      definition: e,
      comments: B(e)
    };
...
function Dt(t) {
  let e = t.firstChild;
  if (!e || e.type !== "expression_statement") {
    return;
  }
  let n = e.firstChild;
  if (n?.type === "string") {
